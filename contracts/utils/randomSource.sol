...
contract randomSource is Ownable {
        ...
        returns (uint16)
    {
        ...
        (uint16 _loc, ) = _getLocU16(
            ...
            _value,
            0,
            uint16(_sumList.length - 1)
        );
        return _loc;
    }

    function genWithPriorDistributionU16SumList(
