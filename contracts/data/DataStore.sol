...
contract DataStore {
    ...
    function grantAddMpAddressSetForAccount(
        address _mpaddress,
        bytes32 _key,
        address _account
    ) internal {
    ...
    function revokeAddMpAddressSetForAccount(
        address _mpaddress,
        bytes32 _key,
        address _account
    ) internal {
    ...
    function getAddMpAddressSetRoles(
        address _mpaddress,
        bytes32 _key,
        uint256 _start,
        uint256 _end
    ...
    function grantAddMpUintSetForAccount(
        address _mpaddress,
        bytes32 _key,
        uint256 _value
    ) internal {
    ...
    function revokeAddMpUintSetForAccount(
        address _mpaddress,
        bytes32 _key,
        uint256 _value
    ) internal {
        ...
        returns (uint256[] memory)
    {
        return
            addUintSetValues[_mpaddress][_key].valuesAt(
                0,
                addUintSetValues[_mpaddress][_key].length()
            );
    }
    ...
    function grantAddMpBytes32SetForAccount(
        address _mpaddress,
        bytes32 _key,
        bytes32 _content
    ) internal {
    ...
    function revokeAddMpBytes32SetForAccount(
        address _mpaddress,
        bytes32 _key,
        bytes32 _content
    ) internal {
    ...
    function getAddMpBytes32SetRoles(
        address _mpaddress,
        bytes32 _key,
        uint256 _start,
        uint256 _end
