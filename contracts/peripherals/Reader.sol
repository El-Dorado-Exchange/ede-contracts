...
contract Reader is Ownable {
        ...
        )
    {
        ...
        uint256 baseBps = isStableSwap
            ? _vaultUtils.stableSwapFeeBasisPoints()
            : _vaultUtils.swapFeeBasisPoints();
        uint256 taxBps = isStableSwap
            ? _vaultUtils.stableTaxBasisPoints()
            : _vaultUtils.taxBasisPoints();
        uint256 feesBasisPoints0 = _vaultUtils.getFeeBasisPoints(
            _tokenIn,
            usdxAmount,
            baseBps,
            taxBps,
        ...
        uint256 feesBasisPoints1 = _vaultUtils.getFeeBasisPoints(
            _tokenOut,
            usdxAmount,
            baseBps,
            taxBps,
